            ...
            <div class="topnav hidden-xs">
                <div class="container">
                    ...
                    <ul class="quick-menu pull-right">
                        ...
                        <li class="ribbon currency menu-color-blue">
                            <a href="#" title="">USD</a>
                            <ul class="menu mini">
                ...
                <div class="container">
                    ...
                    <nav id="main-menu" role="navigation">
                        <ul class="menu">
                            ...
                            <li class="menu-item-has-children menu-color-green">
                            ...
                            <li class="menu-item-has-children megamenu-menu menu-skin-light">
                                <a href="#">Pages</a>
        ...
        <div class="page-title-container">
            <div class="container">
                <div class="page-title pull-left">
                    <h2 class="entry-title">Dropdowns</h2>
                </div>
