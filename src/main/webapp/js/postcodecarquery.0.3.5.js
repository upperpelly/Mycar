...
var PostCodeCarQuery = function(){}

PostCodeCarQuery.prototype = {
...
//alert("out"+out);
 ...
 if(this.cur_year == "")
 {
  ...
  $("select#"+this.trim_select_id).html(this.empty_option_html);
      ...
      //Set a loading message while we retrieve the data
        $("select#"+this.make_select_id).html("<option value=''>Loading States...</option>");
        ...
        this.base_url = 'api/states';
        //alert(this.base_url);
        //Get Car Model JSON for the selected make
     $.getJSON(this.base_url, {country:this.cur_year}, function(data) {
