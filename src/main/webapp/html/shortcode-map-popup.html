        ...
        <div class="page-title-container">
            <div class="container">
                <div class="page-title pull-left">
                    <h2 class="entry-title">Hotel Listings</h2>
                </div>
                <ul class="breadcrumbs pull-right">
                    <li><a href="#">HOME</a></li>
                    <li><a href="#">PAGES</a></li>
                    <li><a href="#">SHORTCODES</a></li>
                    <li class="active">Hotel Listings</li>
                </ul>
            </div>
        </div>
            ...
            <div class="container text-left">
                ...
                <div class="row image-box hotel listing-style1">
                    <div class="col-sm-6 col-md-3">
                        <article class="box">
                            <figure>
                                <a href="ajax/slideshow-popup.html" class="hover-effect popup-gallery" data-box="48.85661, 2.35222"><img width="270" height="160" alt="" src="http://placehold.it/270x160"></a>
                            </figure>
                            <div class="details">
                                <span class="price"><small>avg/night</small>$360</span>
