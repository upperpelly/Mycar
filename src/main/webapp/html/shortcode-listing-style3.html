        ...
        <div class="page-title-container">
            <div class="container">
                <div class="page-title pull-left">
                    <h2 class="entry-title">Listing Style 03</h2>
                </div>
                <ul class="breadcrumbs pull-right">
                    <li><a href="#">HOME</a></li>
                    <li><a href="#">PAGES</a></li>
                    <li><a href="#">SHORTCODES</a></li>
                    <li class="active">listing style 03</li>
                </ul>
            </div>
        </div>
            ...
            <div class="container text-left shortcode">
                ...
                <div class="block">
                    <div class="row">
                        ...
                        <div class="col-lg-9 listing-style3 car">
                            <article class="box">
                                ...
                                <div class="details col-xs-9 clearfix">
                                    <div class="col-sm-8">
                                        <div class="clearfix">
                                            ...
                                            <div class="logo">
                                                <img src="http://placehold.it/70x20" alt="" width="70" height="20" />
                                            </div>
                                        </div>
                                        <div class="amenities">
                                            <ul>
                                    ...
                                    <div class="action col-xs-6 col-sm-2">
                                        ...
                                        <a class="button btn-small full-width">select</a>
                                    </div>
                                </div>
                            </article>
                            <article class="box">
                                ...
                                <div class="details col-xs-9 clearfix">
                                    ...
                                    <div class="action col-xs-6 col-sm-2">
                                        <span class="price"><small>per day</small>$100</span>
                                        <a class="button btn-small full-width">select</a>
                                    </div>
                                </div>
                            </article>
                            <article class="box">
                                ...
                                <div class="details col-xs-9 clearfix">
                                    ...
                                    <div class="action col-xs-6 col-sm-2">
                                        <span class="price"><small>per day</small>$79.39</span>
                                        <a class="button btn-small full-width">select</a>
                                    </div>
                                </div>
                            </article>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 listing-style3 cruise">
                            <article class="box">
                                ...
                                <div class="details col-sm-8">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <a href="#" class="button btn-small pull-right">select cruise</a>
                                    </div>
                                </div>
                            </article>
                            <article class="box">
                                ...
                                <div class="details col-sm-8">
                                    <div class="clearfix">
                                        <h4 class="box-title pull-left">Singapore to Asia<small>4 nights</small></h4>
                                        <span class="price pull-right"><small>from</small>$358</span>
                                    </div>
                                    <div class="character clearfix">
                                        <div class="col-xs-3 cruise-logo">
                                            <img src="http://placehold.it/110x20" alt="" />
                            ...
                            <article class="box">
                                ...
                                <div class="details col-sm-8">
                                    <div class="clearfix">
                                        <h4 class="box-title pull-left">Miami to Florida<small>4 nights</small></h4>
                                        <span class="price pull-right"><small>from</small>$578</span>
                                    </div>
                                    <div class="character clearfix">
                                        <div class="col-xs-3 cruise-logo">
                                            <img src="http://placehold.it/110x20" alt="" />
