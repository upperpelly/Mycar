...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"></h1><a title="Autoscoop" href="Hm_BetaV1.html"><img alt="Autoscoop" style="float:left;" src="images/autoscooplogo1.png"></a>').insertBefore('.chaser .menu');
