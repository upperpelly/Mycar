        ...
        <div class="page-title-container">
            <div class="container">
                <div class="page-title pull-left">
                    <h2 class="entry-title">Listing Style 01</h2>
                </div>
                <ul class="breadcrumbs pull-right">
                    <li><a href="#">HOME</a></li>
                    <li><a href="#">PAGES</a></li>
                    <li><a href="#">SHORTCODES</a></li>
                    <li class="active">listing style 01</li>
                </ul>
            </div>
        </div>
            ...
            <div class="container shortcode">
                        ...
                        <article class="box">
                            ...
                            <div class="details">
                                ...
                                <div class="action">
                                    ...
                                    <a class="button btn-small yellow" href="#">VIEW ON MAP</a>
                                </div>
                            </div>
                        </article>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <article class="box">
                            ...
                            <div class="details">
                                ...
                                <p class="duration"><span class="skin-color">Total Time</span> 13 Hour, 40 minutes</p>
                                <div class="action">
                ...
                <div class="row image-box car listing-style1">
                    <div class="col-sm-6 col-md-3">
                        <article class="box">
                            <figure>
                                <a href="#"><img alt="" src="http://placehold.it/270x160"></a>
                            </figure>
                            <div class="details">
